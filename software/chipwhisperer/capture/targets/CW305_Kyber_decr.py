...
class CW305_Kyber_decr(CW305):
    ...
    def __init__(self):
        ...
        self.REG_CRYPT_SECRET_KEY = None
    ...
    def loadEncryptionKey(self, key):
        if None in [self.REG_CRYPT_SECRET_KEY_0,
                    self.REG_CRYPT_SECRET_KEY_1,
                    self.REG_CRYPT_SECRET_KEY_2,
                    self.REG_CRYPT_SECRET_KEY_3,
                    self.REG_CRYPT_SECRET_KEY_4,
                    self.REG_CRYPT_SECRET_KEY_5]:
            target_logger.error("target.REG_CRYPT_PUBLIC_KEY_n unset. Have you given target a verilog defines file?")
            return
        self.key = key

        self.fpga_write(self.REG_CRYPT_SECRET_KEY_0, key[  0:128])
        self.fpga_write(self.REG_CRYPT_SECRET_KEY_1, key[128:256])
        self.fpga_write(self.REG_CRYPT_SECRET_KEY_2, key[256:384])
        self.fpga_write(self.REG_CRYPT_SECRET_KEY_3, key[384:512])
        self.fpga_write(self.REG_CRYPT_SECRET_KEY_4, key[512:640])
        self.fpga_write(self.REG_CRYPT_SECRET_KEY_5, key[640:768])
    ...
    def readOutput(self):
        ...
        return self.fpga_read(self.REG_CRYPT_M, 32)
